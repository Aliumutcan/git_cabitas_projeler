...
namespace OpenPgpLib
{
    public class OpenPgp
    {
        ...
        public static void EncryptFile(string inputFileName, string outputFileName, PgpPublicKey publicKeyFileName, bool armor, bool withIntegrityCheck)
        {
            PgpPublicKey encKey = publicKeyFileName;
            using (Stream output = File.Create(outputFileName))
            {
                EncryptFile(output, inputFileName, encKey, armor, withIntegrityCheck);
            }
        ...
        public PgpPublicKey PublicPrivateKey(string publicKeyFileName)
        {
            return ReadPublicKey(publicKeyFileName);
        }
    }
}
